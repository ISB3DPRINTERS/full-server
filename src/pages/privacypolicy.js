...
export default function privacypolicy() {
  return (
    <div>
      ...
      <p>
        ISB3DPRINTERS takes your privacy seriously. To better protect your
      ...
      <p>
        This website tracks basic information about their users. This
      ...
      <h2 id="changes-to-this-privacy-policythis-privacy-policy-is-effective-as-of-12-31-2023-and-will-remain-in-effect-except-with-respect-to-any-changes-in-its-provisions-in-the-future-which-will-be-in-effect-immediately-after-being-posted-on-this-page-">
        Changes To This Privacy PolicyThis Privacy Policy is effective as of
        12/31/2023 and will remain in effect except with respect to any changes
      ...
      <p>
        ...
        us an email to ravinder-Olivier@outlook.com.
      </p>
    </div>
  );
}
